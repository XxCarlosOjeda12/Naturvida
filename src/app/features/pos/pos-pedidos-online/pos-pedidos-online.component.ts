...
import { PosOrdenDetalleComponent } from '../pos-ordenes/pos-orden-detalle.component';

@Component({
  selector: 'app-pos-pedidos-online',
  standalone: true,
      ...
      <div class="container mx-auto">
        <div class="flex justify-between items-center mb-6">
          <h1 class="text-3xl font-bold text-gray-800">
            <i class="fas fa-globe mr-2 text-primary"></i>Pedidos Online
          </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div *ngFor="let orden of ordenes()" 
               class="bg-white rounded-xl shadow-lg p-6 border-l-4 relative"
        ...
        <div *ngIf="ordenes().length === 0" class="text-center py-16">
          ...
          <p class="text-gray-500 text-lg">No hay pedidos online</p>
        </div>
      </div>
    </div>
...
export class PosPedidosOnlineComponent {
  ...
  ordenes = signal<Orden[]>([
    {
      ...
      hora: '10:15',
      productos: [
        { id: '10', sku: 'COL-005', nombre: 'Colágeno Hidrolizado', precio: 450, cantidad: 1, subtotal: 450 }
      ],
      subtotal: 450,
      iva: 72,
      total: 522,
      metodoPago: 'tarjeta',
      numeroTicket: 'TKT-WEB-001',
      tipoEntrega: 'envio',
      estado: 'pendiente'
    },
    {
      ...
      hora: '11:30',
      productos: [
        { id: '5', sku: 'TEA-001', nombre: 'Té Matcha Ceremonial', precio: 320, cantidad: 2, subtotal: 640 }
      ],
      subtotal: 640,
      iva: 102.4,
      total: 742.4,
      metodoPago: 'transferencia',
      numeroTicket: 'TKT-WEB-002',
      tipoEntrega: 'recoger',
      estado: 'preparando'
    }
  ]);
